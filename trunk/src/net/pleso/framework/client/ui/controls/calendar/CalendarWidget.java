...
public class CalendarWidget extends Composite 
  ...
  private String[] days = new String[] { 
	  FrameworkLocale.constants().calendar_sunday(), 
	  FrameworkLocale.constants().calendar_monday(), 
	  FrameworkLocale.constants().calendar_tuesday(),
	  FrameworkLocale.constants().calendar_wednesday(), 
	  FrameworkLocale.constants().calendar_thursday(), 
	  FrameworkLocale.constants().calendar_friday(), 
	  FrameworkLocale.constants().calendar_saturday() };

  private String[] months = new String[] { 
	  FrameworkLocale.constants().calendar_january(), 
	  FrameworkLocale.constants().calendar_february(), 
	  FrameworkLocale.constants().calendar_march(),
	  FrameworkLocale.constants().calendar_april(), 
	  FrameworkLocale.constants().calendar_may(), 
	  FrameworkLocale.constants().calendar_june(), 
	  FrameworkLocale.constants().calendar_july(), 
	  FrameworkLocale.constants().calendar_august(), 
	  FrameworkLocale.constants().calendar_september(), 
	  FrameworkLocale.constants().calendar_october(),
	  FrameworkLocale.constants().calendar_november(), 
	  FrameworkLocale.constants().calendar_december()
  };
