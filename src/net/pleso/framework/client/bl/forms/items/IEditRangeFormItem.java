 ...
 */
public interface IEditRangeFormItem extends IEditFormItem {

	/**
	 * Returns edited column for low range value.
	 * 
	 * @return edited column for low range value
	 */
	IDataColumn getLowBoundDataColumn();

	/**
	 * Returns edited column for high range value.
	 * 
	 * @return edited column for high range value
	 */
	IDataColumn getHighBoundDataColumn();
